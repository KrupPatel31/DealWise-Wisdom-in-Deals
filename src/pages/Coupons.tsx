...
const Coupons = () => {
  ...
  const stores = useMemo(
    () => [...new Set(coupons.map((c) => c.store))],
    [coupons],
  );
  const categories = useMemo(
    () => [...new Set(coupons.map((c) => c.category))],
    [coupons],
  );
      ...
      <main className="container mx-auto px-4 py-6 sm:py-8">
        <div className="text-center space-y-2 mb-6 sm:mb-8">
          ...
          <p className="text-sm sm:text-base text-muted-foreground">
            All coupons listed here are now valid at checkout
          </p>
        </div>
                ...
                >
                  ...
                  <CardContent className="p-4 pl-5">
                    <div className="flex items-start justify-between gap-2 mb-3">
                      ...
                      <Badge
                        className={`shrink-0 ${getTypeColor(coupon.coupon_type)}`}
                      >
                    ...
                    <div className="mt-2 text-xs text-muted-foreground">
                      Used {coupon.used_count.toLocaleString()} times
                    </div>
                  </CardContent>
                </Card>
              );
