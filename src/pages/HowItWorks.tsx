...
const steps = [
  {
    ...
    icon: Search,
    title: "SEARCH",
    description: "Enter the product name or paste a product URL from any major retailer",
    details: "Our AI-powered search engine instantly recognizes products across thousands of online stores"
  },
  {
    number: "02", 
    icon: Eye,
    ...
    details: "See current prices, shipping costs, taxes, and total costs from all major retailers"
  },
  {
    number: "03",
    icon: TrendingUp,
    title: "ANALYZE",
    description: "Get intelligent insights on price trends and best buying opportunities",
    details: "Historical data, price predictions, and seasonal trends help you make smart decisions"
  },
  {
    number: "04",
    icon: ShoppingCart,
    title: "SAVE",
    description: "Buy from the best deal or set price alerts for future purchases",
    details: "Direct links to stores, coupon codes, and cashback opportunities maximize your savings"
  }
];
      ...
      <main className="container mx-auto px-6 py-20">
        <div className="text-center space-y-6 mb-20">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Save money in 4 easy steps with our intelligent price comparison platform
          </p>
        </div>
              ...
              <div className="text-center space-y-6">
                ...
                <div className="space-y-4">
                  <h3 className="text-2xl font-bold">
                    <span className="text-primary">SAVE UP TO</span><br />
