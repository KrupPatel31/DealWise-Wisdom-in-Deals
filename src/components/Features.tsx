...
const features = [
  ...
  },
  {
    ...
    description:
      "Track price changes and get notified when deals become available",
  },
  {
    icon: Brain,
    title: "SMART ANALYSIS",
    description:
      "Analyze payment options and promotional benefits automatically",
  },
];
    ...
    <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 lg:py-20">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
        {features.map((feature, index) => (
          <Card
            key={index}
            className="p-6 sm:p-8 text-center bg-deal border-deal-border hover:border-accent/50 transition-all duration-300 group"
          >
