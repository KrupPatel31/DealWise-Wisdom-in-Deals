      ...
      <Card className="bg-deal border-deal-border overflow-hidden hover-lift hover-glow group animate-fade-up h-full flex flex-col">
        <div className="relative overflow-hidden flex-shrink-0">
          ...
          <div className="absolute bottom-2 sm:bottom-4 left-2 sm:left-4">
            <Badge
              variant="outline"
              className="bg-white/10 backdrop-blur-md border-white/20 text-white text-xs sm:text-sm"
            >
              {store}
            </Badge>
          </div>
          ...
          <div className="flex flex-wrap gap-1 mt-2 sm:mt-3 h-8 sm:h-9 flex-shrink-0 overflow-hidden">
            {features.slice(0, 3).map((feature, index) => (
              <Badge
                key={index}
                variant="secondary"
                className="text-[10px] sm:text-xs px-1.5 sm:px-2 py-0.5 sm:py-1 bg-muted/50 text-muted-foreground h-fit"
              >
                {feature}
              </Badge>
            ))}
